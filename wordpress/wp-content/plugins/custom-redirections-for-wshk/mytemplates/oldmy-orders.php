...
global $paged;
$wshknumeropedidos = '2';//get_option('wshk_numeropedidos');
...
$pluginOptionsVal=get_wshk_sidebar_options();
$wshknumeropedidos = get_option('wshk_numeropedidos');*/
if ( !empty($wshknumeropedidos)/*!= '0'*/) {
$total_pages = ceil($total_records / $posts_per_page/*$wshknumeropedidos*/);
} else {
    /*global $pluginOptionsVal;
$pluginOptionsVal=get_wshk_sidebar_options();*/
    $posts_per_page = '15';
...
$customer_orders = get_posts(array(
    ...
    'meta_value' => get_current_user_id(),
    'post_type' => wc_get_order_types('view-orders'),
    'posts_per_page' => $posts_per_page,//$wshknumeropedidos
    'paged' => $paged,
    'post_status' => array_keys(wc_get_order_statuses())
));
