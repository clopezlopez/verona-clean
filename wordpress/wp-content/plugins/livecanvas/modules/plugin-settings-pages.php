		...
		<form method="post">
			...
			<table id="lc-settings-table">
				...
				<tr>
					...
					<td>
						<label>
							<input name="header" type="checkbox" value="1" <?php if (isset($lc_settings['header'])) echo "checked"; ?> > Use LiveCanvas to design the header <i style="color:red">(requires picostrap)</i>
				...
				<tr>
					...
					<td>
						<label>
							<input name="footerV2" type="checkbox" value="1" <?php if (isset($lc_settings['footerV2'])) echo "checked"; ?> > Use LiveCanvas to design the footer <i style="color:red">(requires picostrap)</i>
					...
					<td>
						<label>
							<input name="enable-dynamic-templating" type="checkbox" value="1" <?php if (isset($lc_settings['enable-dynamic-templating'])) echo "checked"; ?> >
							  Allows building template pages with LiveCanvas. See the Dynamic Templates menu on the left side.
						</label>
					 </td>
				</tr>
